...
export function Wrapper(props: { children: React.ReactNode }) {
	return (
		<div className=" dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex justify-center">
			...
			<div className="size-full pt-20">{props.children}</div>
		</div>
	);
}
...
export function ReactQueryProvider(props: { children: React.ReactNode | any }) {
	return (
