...
interface ChartTooltipContentProps {
	...
	formatter?: (value: any, name: any, props: any, index: number, payload: any) => any;
...
const ChartContainer = React.forwardRef<
	HTMLDivElement,
	{ id?: string; className?: string; config: ChartConfig; children: React.ReactNode } & React.HTMLAttributes<HTMLDivElement>
