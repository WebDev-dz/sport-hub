...
import { group, sports_member, training_session, user } from "@prisma/client";
import useAttendance from "@/hooks/use-attendance";
import { uuidv4 } from "zod/v4";

type Props = {
  sessionsWithMembers: (training_session & {
    members: ({ attendanceStatus: string , groupMembers: {group: group}[] } & sports_member)[];
